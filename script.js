...
var content = document.getElementById("content"); // inserção, precisamos acessar o getelementbyId, precisamos colocar os cards dentro da sessao "content" (ID). 


    for (var bio in biografias) {
        content.innerHTML += '<div class="card">' +  // atribuição, o id vai receber um trecho de codigo html 
        '<img src="'  + biografias[bio].imagem +'"/>' + 
        '<details>'+ 
        '<summary>' + 
        biografias[bio].nome + 
         '</summary>'+
         '<p>' + biografias[bio].descrição +
         '</p>'+
         '<blockquote><q>' + biografias[bio].citação + "</q></blockquote>" + 
         '</details></div>';                      
